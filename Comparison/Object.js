// An object is a collection of related data stored using key: value pairs.
// object is non prmitive 
// without class we can create object 
...
console.log(user); // { username: 'admin', password: 'admin123', role: 'admin' }
...
console.log(userx.name); //Cannot read properties of null
